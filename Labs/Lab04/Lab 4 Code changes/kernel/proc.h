...
// MRU page entry for global MRU list
struct mru_page {
  struct proc *proc;         // Process that owns this page
  uint64 va;                 // Virtual address of the page
  struct mru_page *next;     // Next in MRU list
  struct mru_page *prev;     // Previous in MRU list
};
